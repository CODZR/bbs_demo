...
from . import filesys_serializer
...
class LoginAPI(views.APIView):
    ...
    def post(self,request,*args,**kwargs):
        ret={}
        user_serializer=filesys_serializer.UserSerisalizer(data=request.data)
        if user_serializer.is_valid():
            ...
            if not user_list:
                ...
                ret=filesys_serializer.UserSerisalizer(user_list[0]).data
                ret['token']=token.key
            return Response(ret)
        else:
    ...
    def post(self,request,*args,**kwargs):
        ...
        if user_serializer.is_valid():
            ...
            if user_list:
                ...
                user_serializer=filesys_serializer.UserSerisalizer(user)
